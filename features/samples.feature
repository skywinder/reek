Feature: Basic smell detection
  ...
  Scenario: Correct smells from optparse.rb
    ...
    optparse.rb -- 119 warnings:
      ...
      OptionParser#banner is a writeable attribute (Attribute)
      ...
      OptionParser#default_argv is a writeable attribute (Attribute)
      ...
      OptionParser#program_name is a writeable attribute (Attribute)
      OptionParser#release is a writeable attribute (Attribute)
      ...
      OptionParser#summary_indent is a writeable attribute (Attribute)
      OptionParser#summary_width is a writeable attribute (Attribute)
      OptionParser#ver has the variable name 'v' (UncommunicativeVariableName)
      OptionParser#version is a writeable attribute (Attribute)
      ...
      OptionParser::ParseError#reason is a writeable attribute (Attribute)
  ...
  Scenario: Correct smells from redcloth.rb
    ...
    redcloth.rb -- 101 warnings:
      ...
      RedCloth#filter_html is a writeable attribute (Attribute)
      RedCloth#filter_styles is a writeable attribute (Attribute)
      ...
      RedCloth#hard_breaks is a writeable attribute (Attribute)
      ...
      RedCloth#lite_mode is a writeable attribute (Attribute)
      RedCloth#no_span_caps is a writeable attribute (Attribute)
      ...
      RedCloth#rules is a writeable attribute (Attribute)
